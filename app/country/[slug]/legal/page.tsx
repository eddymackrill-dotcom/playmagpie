...
const legalContent: Record<string, LegalContent> = {
  canada: {
    metaTitle: 'Is Crypto Gambling Legal in Canada? Laws & Tax 2026 | PlayMagpie',
    metaDescription:
  ...
  australia: {
    metaTitle: 'Is Crypto Gambling Legal in Australia? Laws & Tax 2026 | PlayMagpie',
    metaDescription:
    ...
    blocks: [
      ...
      { type: 'callout', title: 'Not tax advice', text: 'This is general ATO-sourced information, not personal advice. The business-of-gambling test and crypto cost-base rules can change the outcome in individual cases — confirm with the ATO or a registered tax agent.' },
    ...
    faqs: [
      ...
      { question: 'Do I owe tax on crypto I use at a casino?', answer: 'Possibly — on the crypto, not the winnings. A crypto asset is a CGT asset, so selling, swapping, gifting or spending it is a CGT event. If you win crypto, the receipt isn’t taxed and the cost base is its market value at that time, but disposing of it later is a CGT event separate from the winnings.' },
    ],
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        ...
        <section className="mt-10 pt-8 border-t border-[#222222]">
          ...
          <p className="text-[#555555] text-xs mt-4 leading-relaxed">
            General information, not legal or tax advice. Gambling laws and tax treatment change — verify your own
