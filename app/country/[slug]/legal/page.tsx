...
const legalContent: Record<string, LegalContent> = {
  canada: {
    ...
    blocks: [
      ...
      { type: 'p', text: "The date that matters next is 13 October 2026: the regulator's deadline for grey-market operators serving Albertans to come into the licensed system or leave. Several brands have already crossed over from the unlicensed market, and others have said publicly that they will switch closer to the deadline. As of 11 August 2026 that transition is in progress, which means the set of licensed sites available to an Albertan is still growing month by month." },
